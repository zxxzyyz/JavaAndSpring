...
public class QAlbum extends EntityPathBase<Album> {
    ...
    private static final long serialVersionUID = -1312484446L;
    ...
    //inherited
    public final ListPath<hello.Jpa1.domain.Category, hello.Jpa1.domain.QCategory> categories = _super.categories;
